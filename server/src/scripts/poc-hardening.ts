// PoC SUITE for the pre-mainnet backend hardening (audit findings B-1,2,3,5,6). OFFLINE + non-destructive:
...
async function main(): Promise<void> {
  ...
  // the EXACT condition runGeneration uses to throw TeeVerificationError (block mint + attestation):
