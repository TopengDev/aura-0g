// SERVER-ONLY. The SPONSOR wallet - the ONLY key on the tx-sending (gas) path. It pays 0G Compute + 0G
// Storage for generation (it signs the compute-ledger funding txs). It NEVER signs a user's
// mintOutput / mintAgent / list / buy. Those are returned as args for the user's own wallet to submit.
//
