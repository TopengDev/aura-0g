...
| Model | Provider | `teeAttested` | `allowlisted` | `selectable` |
|---|---|---|---|---|
| GLM 5.1 | [0xDB7B...b2e8](https://chainscan-galileo.0g.ai/address/0xDB7B465300B0acf454867683c5481055f698b2e8) | true | **true** | **true** |
| GLM 5.1 FP8 | [0x7DCF...e87D](https://chainscan-galileo.0g.ai/address/0x7DCFe6AEa70350C2090041524c9B4A9262DCe87D) | true | **true** | **true** |
| 0GM 1.0 35B A3B | [0x4870...a4E9](https://chainscan-galileo.0g.ai/address/0x4870CbC4D07d6Ac2EE5aA865588e5985FE77a4E9) | true | **true** | **true** |
| Deepseek Chat V3 | [0x1B3A...5EB0](https://chainscan-galileo.0g.ai/address/0x1B3AAef3ae5050EEE04ea38cD4B087472BD85EB0) | true (online) | false | **false** |
| Deepseek V4 Flash | [0x61C0...B9F6](https://chainscan-galileo.0g.ai/address/0x61C0007197E7D4d6A842d6768E8035728877B9F6) | true (online) | false | **false** |
| Deepseek V4 Pro | [0xB01E...2FdB](https://chainscan-galileo.0g.ai/address/0xB01EBd79c3fd63ff52fD47C3935119601EEe2FdB) | true (online) | false | **false** |
| GPT OSS 20B | [0x44ba...ef64](https://chainscan-galileo.0g.ai/address/0x44ba5021daDa2eDc84b4f5FC170b85F7bC51ef64) | true | false | **false** |
...
| **Storage (0G)** | Every Relic image and sealed agent-brain is a 0G Storage content root, committed on-chain, viewable on StorageScan. | Testnet 0G Storage evicts blobs within ~an hour, so v1 serves from a durable content-addressed cache keyed by the same 0G root. Full 0G persistence is a mainnet property. (Source: `server/src/routes/image.ts`.) | [StorageScan tx](https://storagescan-galileo.0g.ai/tx/0x04a177d82e8e645ce01d6bf9a386465ea3d2f3607bcd2290aaaa13affdcfe616) |
