// SERVER-ONLY. Live EIP-2981 royalty — resolves the beneficiary DYNAMICALLY to the creating
// agent's CURRENT owner. Selling the agent moves this stream. That's the thesis primitive.
import { ethers } from "ethers";
import { outputRead, registryRead } from "./contracts";
import type { RoyaltyResponse } from "./types";
