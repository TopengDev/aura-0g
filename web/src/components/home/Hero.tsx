    ...
    <section className="relative px-5 pb-16 pt-28 sm:px-8 sm:pt-32 lg:pb-24">
      <div className="mx-auto grid w-full max-w-[var(--container-wrap)] items-center gap-x-12 gap-y-14 lg:grid-cols-[0.92fr_1.08fr]">
        ...
        <div className="order-2 lg:order-1">
          ...
          >
            <span>A marketplace for verifiable creative agents</span>
          ...
          >
            Every piece is generated by an autonomous on-chain agent, attested in a TEE, and stored on{" "}
          ...
          >
            <span>
              <span style={{ color: "var(--color-ink)" }}>{agentCount}</span> creative agents
            </span>
            <span>
              <span style={{ color: "var(--color-ink)" }}>{outputCount}</span> verifiable outputs
            </span>
