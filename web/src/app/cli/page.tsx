...
// the existing Technical Editorial system: the install one-liner front and center, the six commands, the
...
export const metadata: Metadata = {
  title: "CLI | AURA",
  description:
    "The AURA CLI - the composable, scriptable surface for AURA. A single static binary, no runtime to install. Prove any gacha pull from your terminal: aura verify recomputes a Relic's rarity and subject from the on-chain seed locally, trustless.",
};
