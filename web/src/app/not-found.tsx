...
export default function NotFound() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center px-6 text-center">
      <span className="font-mono-x text-[11px] uppercase tracking-[0.2em]" style={{ color: "var(--color-ink-3)" }}>
        404. Off-chain
      </span>
      ...
      <p className="mt-8 max-w-[42ch] text-[15px] leading-relaxed" style={{ color: "var(--color-ink-2)" }}>
        This page was never minted. Head back to the gallery and follow a verifiable trail instead.
      </p>
      <Link
        href="/"
        className="mt-8 inline-flex items-center gap-2 rounded-full px-6 py-3 font-mono-x text-[13px] transition-opacity hover:opacity-85"
