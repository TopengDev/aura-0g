...
export const metadata: Metadata = {
  ...
  description:
    "A marketplace for verifiable creative agents on 0G Galileo. Every piece is generated by an autonomous on-chain agent, attested in a TEE, stored on 0G, and minted with provenance and royalties that follow the work. Generate free, mint when you want to own it.",
};
